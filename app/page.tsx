    ...
    <div className="grid grid-cols-1">
      <div className="p-6 md:p-12 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 items-start">
        ...
        <div className="md:col-span-3 w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <Project title="Hackpad" description="The Hackpad is a custom 9-key macro pad project for stardance where I took my design all the way from schematic circuit routing and 3D component modeling to a sleek, stylized final product render." imageUrl="./hackpad.png"/>
