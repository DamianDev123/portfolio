    ...
    <div className="grid grid-cols-1">
      <div className="p-6 md:p-12 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 items-start">
        ...
        <div className="md:col-span-3 w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <Project title="Hackpad" description="The Hackpad is a custom 9-key macro pad project for stardance where I took my design all the way from schematic circuit routing and 3D component modeling to a sleek, stylized final product render." imageUrl="./hackpad.png" githubUrl="https://github.com/DamianDev123/Hacking_a_Keyboard"/>
          <Project title="FTC DECODE ROBOT" description="During the FIRST Tech Challenge, I led a team of students to design and build a competitive robot. My team learned CAD, Programming, and competition skills." imageUrl="./robot.png" githubUrl="https://github.com/DamianDev123/KD-2026" mediaLink="https://cad.onshape.com/documents/988d6c192ab16ebbe882aabc/w/7ee2500ced18c18db6b1746a/e/1c978d95b104076ecf6940b7" mediaType="OnShape"/>
          <Project title="Walker Wheels" description="Walker wheels is a project that I did in collaboration with NYCFirst, in which we aimed to assist ederly by modifying their walker so that they could go travel more easy" imageUrl="/project4.jpg"/>
        </div>
