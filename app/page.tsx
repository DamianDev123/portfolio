    ...
    <div className="grid grid-cols-1">
      <div className="p-6 md:p-12 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 items-start">
        ...
        <div className="md:col-span-3 w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <Project title="Walker Wheels" description="Walker wheels is a project that I did in collaboration with NYCFirst, in which we aimed to assist ederly by modifying their walker so that they could go travel more easy" imageUrl="./walker.png"/>
        </div>
